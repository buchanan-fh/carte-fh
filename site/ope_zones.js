...
nature_support["26"]="Pylône tubulaire";
...
nature_support["999999999"]="Support non décrit";
...
"PMT/Vodafone","WLL","BPT","SPM Telecom","McKay Brothers International","Telco OI","METEO","BJT PARTNERS"];
...
"Martinique numérique","SPLANG","STOI","VITI SAS","PMT/Vodafone","WLL","BPT","SPM Telecom","McKay Brothers International","Telco OI","METEO","BJT PARTNERS"];
...
liste_ope_zones=[];
liste_ope_zones["fr_metro"]={nom_zone:"France métropolitaine", bounds:[[41,-5.7],[51.5,10]], main:[1,2,3,4], other:[5,6,7,8,9,10,11,12,13,87,24,16,26,33,39,40,41,42,44,45,46,47,60,65,85,48,49,50,51,52,
...
liste_ope_zones["fr_976"]={nom_zone:"Mayotte (976)", bounds:[[-13.1,44.9],[-12.55,45.33]], main:[1,70,73,86], other:[5,8,79,88]}
