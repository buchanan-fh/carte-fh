            ...
            d.spiderfy = function(c, b) {
                ...
                a = function() {
                    ...
                    for (b = d.length; a < b; a++) g = d[a], e = this.map.layerPointToLatLng(g), n = this.minExtract(c, function(a) {
                        ...
                        leg: p
                    }, this.legColors.highlighted !== this.legColors.usual && (l = this.makeHighlightListeners(h), h._omsData.highlightListeners = l, h.addEventListener("mouseover", l.highlight), h.addEventListener("mouseout", l.unhighlight)), h.setLatLng(e); if(h._path){h.bringToFront()}else{h.setZIndexOffset(1E6)}; k.push(h);
                    return k
                }.call(this);
            ...
            d.unspiderfy = function(c) {
                ...
                for (k = h.length; f < k; f++){
					...
					if(null != b._omsData){
						...
						null != a && (b.removeEventListener("mouseover", a.highlight), b.removeEventListener("mouseout", a.unhighlight));
						delete b._omsData, d.push(b);
						if(h._path){h.bringToBack()}
					}else{
						e.push(b);
					}
				}
