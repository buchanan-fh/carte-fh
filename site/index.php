	...
	<div id="detail_sup">
		<div id="d_sup">
			...
			<div id="d_links">
				...
				<div id="d_list_links">Vers ce support: <input id="d_link_to_sup" type="text" readonly><br><a id="d_link_galerie" href="">Vers la galerie photo</a><br><a id="d_link_cartoradio" href="">Vers cartoradio</a><br><a id="d_link_gmaps" href="">Vers Google Maps</a></div>
			</div>
		</div>
	</div>
	<div id="map_global">
